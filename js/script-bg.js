...
const background_color = {
    'first': {
        'start': hexstr_to_rgb(get_variable_value_from_class(`.body--${get_page_name()}`, '--bg-color-first-start')),
        'end': hexstr_to_rgb(get_variable_value_from_class(`.body--${get_page_name()}`, '--bg-color-first-end'))
    },
    'last': {
        'start': hexstr_to_rgb(get_variable_value_from_class(`.body--${get_page_name()}`, '--bg-color-last-start')),
        'end': hexstr_to_rgb(get_variable_value_from_class(`.body--${get_page_name()}`, '--bg-color-last-end'))
    }
}
...
window.addEventListener('scroll', () => {
    ...
    set_variable_value_from_class('.body--history', '--bg-color-current-start', `rgb(${bg_col_start_r}, ${bg_col_start_g}, ${bg_col_start_b})`);
    set_variable_value_from_class('.body--history', '--bg-color-current-end', `rgb(${bg_col_end_r}, ${bg_col_end_g}, ${bg_col_end_b})`);
});